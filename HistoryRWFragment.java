 ...
 */
public class HistoryRWFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View inflaterView = inflater.inflate(R.layout.fragment_history_rw, container, false);
            ...
            public void onResponse(Call<ResponseModel> call, Response<ResponseModel> response) {
                ...
                if (list == null) {
                    ...
                    for (final SuratMenungguDiketahui s : list) {
                        if ((s.getPERRW() != null && s.getPERRW().contains(posisiRW)) && (s.getpERACCRW()) != null && s.getpERACCRW().contains(posisiRW)) {
